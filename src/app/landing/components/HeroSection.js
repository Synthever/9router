    ...
    <section className="relative pt-32 pb-20 px-6 min-h-[90vh] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl w-full text-center flex flex-col items-center gap-8">
        ...
        <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto font-light">
          Unified AI routing gateway with format translation, combo fallback, token quotas, and instant monitoring. Works seamlessly with Claude Code, OpenAI Codex, Cline, RooCode, and custom applications.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 w-full">
          <button
            ...
            className="h-12 px-8 rounded-lg bg-[#f97815] hover:bg-[#e0650a] text-[#181411] text-base font-bold transition-all shadow-[0_0_15px_rgba(249,120,21,0.4)] flex items-center gap-2 cursor-pointer"
          >
            <span className="material-symbols-outlined">key</span>
            User Portal
          </button>
          <a 
            href="https://github.com/Synthever/9router" 
            target="_blank" 
